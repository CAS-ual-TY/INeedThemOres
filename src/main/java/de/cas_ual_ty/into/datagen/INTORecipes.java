    ...
    protected void registerRecipes(Consumer<IFinishedRecipe> consumer)
    {
        for(INTOMaterial material : INTOMaterial.MATERIALS)
        {
            ShapedRecipeBuilder.shapedRecipe(material.getBlock())
                ...
                .addCriterion("has_" + material.ingotRL.getPath(), RecipeProvider.hasItem(material.ingot_tag))
                .build(consumer);
            ...
            ShapedRecipeBuilder.shapedRecipe(material.getIngot())
                ...
                .setGroup(INeedThemOres.MOD_ID + "_" + material.name)
                .addCriterion("has_" + material.nuggetRL.getPath(), RecipeProvider.hasItem(material.nugget_tag))
            ...
            ShapelessRecipeBuilder.shapelessRecipe(material.getIngot(), 9)
                ...
                .setGroup(INeedThemOres.MOD_ID + "_" + material.name)
                .addCriterion("has_" + material.blockRL.getPath(), RecipeProvider.hasItem(material.block_item_tag))
            ...
            CookingRecipeBuilder.smeltingRecipe(Ingredient.fromTag(material.ore_item_tag), material.getIngot(), 1.0F, 200).addCriterion("has_" + material.oreRL.getPath(), RecipeProvider.hasItem(material.getOre())).build(consumer);
            CookingRecipeBuilder.blastingRecipe(Ingredient.fromTag(material.ore_item_tag), material.getIngot(), 1.0F, 100).addCriterion("has_" + material.oreRL.getPath(), RecipeProvider.hasItem(material.getOre())).build(consumer, new ResourceLocation(material.modId, material.ingotRL.getPath() + "_from_blasting"));
        }
    }
}
